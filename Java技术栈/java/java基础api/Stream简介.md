...
### [Stream介绍](https://hollischuang.gitee.io/tobetopjavaer/#/basics/java-basic/stream?id=stream介绍)
...
![img](https://raw.githubusercontent.com/tiaotiaopig/feng-images-store/main/images/15521192454583.jpg)￼
...
### [Stream的创建](https://hollischuang.gitee.io/tobetopjavaer/#/basics/java-basic/stream?id=stream的创建)
...
Stream<String> stream = strings.stream();复制ErrorOK!
```
...
```markup
Stream<String> stream = Stream.of("Hollis", "HollisChuang", "hollis", "Hello", "HelloWorld", "Hollis");复制ErrorOK!
```

如以上代码，直接通过of方法，创建并返回一个Stream。

### [Stream中间操作](https://hollischuang.gitee.io/tobetopjavaer/#/basics/java-basic/stream?id=stream中间操作)

Stream有很多中间操作，多个中间操作可以连接起来形成一个流水线，每一个中间操作就像流水线上的一个工人，每人工人都可以对流进行加工，加工后得到的结果还是一个流。

![img](https://raw.githubusercontent.com/tiaotiaopig/feng-images-store/main/images/15521194075219.jpg)￼

以下是常用的中间操作列表:

![img](https://raw.githubusercontent.com/tiaotiaopig/feng-images-store/main/images/15521194556484.jpg)￼
...
//Hollis, HollisChuang, H, hollis复制ErrorOK!
```
...
![img](https://raw.githubusercontent.com/tiaotiaopig/feng-images-store/main/images/15521242025506.jpg)￼

### [Stream最终操作](https://hollischuang.gitee.io/tobetopjavaer/#/basics/java-basic/stream?id=stream最终操作)
...
![img](https://raw.githubusercontent.com/tiaotiaopig/feng-images-store/main/images/15521194606851.jpg)￼
...
下图，展示了文中介绍的所有操作的位置、输入、输出以及使用一个案例展示了其结果。 ![img](https://raw.githubusercontent.com/tiaotiaopig/feng-images-store/main/images/15521245463720.jpg)

### [总结](https://hollischuang.gitee.io/tobetopjavaer/#/basics/java-basic/stream?id=总结)
