...
flyway 是一个数据库版本控制的中间件，是一个数据迁移工具。
...
![img](https://i.loli.net/2021/06/12/TRy39CkLJQaKIes.png)
...
![img](https://i.loli.net/2021/06/12/eWMTKbjIh6tLNok.png)
...
![img](https://i.loli.net/2021/06/12/bQoGTOrKkZ2fgsl.png)

migrations 将根据版本号排序并按序执行。

![img](https://i.loli.net/2021/06/12/RW9EtprNakGjKJz.png)
...
```sql
insert into PERSON (ID, NAME) VALUES (NULL, 'Axel');
insert into PERSON (ID, NAME) VALUES (NULL, 'Mr. Foo');
insert into PERSON (ID, NAME) VALUES (NULL, 'Ms. Bar');
```
...
![img](https://i.loli.net/2021/06/12/zpMlxQLKcRPJtyn.png)
...
![img](http://www.wenjiangs.com/wp-content/uploads/2020/docimg24/java-migrations.png)
