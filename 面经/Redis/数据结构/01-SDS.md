...
>
> 1. SDS结构体设计,可以O(1)时间复杂度获取字符串长度
> 2. 调用SDS的API对SDS进行修改时,API会自动检查剩余空间是否充足,不足时会自动扩容.避免缓存区溢出
> 3. 每次扩容会采用**空间预分配**策略.额外申请一倍空间作为空闲(小于1MB翻倍,大于1MB就是1MB),缩容采用**惰性空间释放**策略,多出的空间作为未使用空间,没有真正释放.减少字符串修改带来的内存重分配次数
> 4. 二进制安全的,可以存放任意二进制数据,数据存入什么样,取出时就是什么样.
> 5. 多种大小的数据结构,取消优化对齐,从而节省内存空间.
...
![img](https://raw.githubusercontent.com/tiaotiaopig/feng-images-store/main/images/376128646c75a893ad47914858fa2131.png)
...
![img](https://raw.githubusercontent.com/tiaotiaopig/feng-images-store/main/images/bcf6bde3b647bdc343efcbc1a8f10579.png)
...
![img](https://raw.githubusercontent.com/tiaotiaopig/feng-images-store/main/images/6286480eb1840a8930e18fd215d82565.png)
...
![img](https://raw.githubusercontent.com/tiaotiaopig/feng-images-store/main/images/516738c4058cdf9109e40a7812ef4239.png)
...
![img](https://raw.githubusercontent.com/tiaotiaopig/feng-images-store/main/images/35820959e8cf4376391c427ed7f81495.png)
...
![img](https://raw.githubusercontent.com/tiaotiaopig/feng-images-store/main/images/47e6c8fbc17fd6c89bdfcb5eedaaacff.png)
